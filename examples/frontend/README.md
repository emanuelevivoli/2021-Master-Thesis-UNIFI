# Example of semantic engineering search
This repository have been borrowed from [the code](https://github.com/kstathou/vector_engine) for the following Medium blogs:
